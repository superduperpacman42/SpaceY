...
%     if norm(rocket - mars) < 0.56e9
%         v_rocket = v_rocket + thrust(v_fuel, m_fuel2, m_rocket-m_fuel2, -v_rocket);
%     end
%     dS = [v_rocket'; v_earth'; v_mars'; a_rocket'; a_earth'; a_mars'; 0; 0; 0; 0; 0];
% end